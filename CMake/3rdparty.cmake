IF(WIN32)
  ...
  IF(DCMTK_WITH_OPENJPEG2)
    ...
    IF(OPENJPEG2_FOUND)
      MESSAGE(STATUS "Info: DCMTK OPENJPEG2 support will be enabled")
      SET(WITH_OPENJPEG2 1)
    ELSE(OPENJPEG2_FOUND)
      MESSAGE(STATUS "Warning: missing OpenJPEG2.")

      SET(DCMTK_WITH_OPENJPEG2 OFF CACHE BOOL "" FORCE)
      SET(WITH_OPENJPEG2 "")

      SET(LIBOPENJPEG2_INCLUDE_DIR)
      SET(LIBOPENJPEG2_LIBRARY)
